...
export const ShoppingCartProvider = ( {children}) => {
        ...
        const items = [
            {
                ...
                "creationAt": "2025-01-09T01:40:52.000Z",
                "updatedAt": "2025-01-09T01:40:52.000Z",
                "category": {
                    "id": 1,
                    "name": "Clothes",
            ...
            },
            {
                ...
                "creationAt": "2025-01-09T03:04:19.000Z",
                "updatedAt": "2025-01-09T03:04:19.000Z",
                "category": {
                    "id": 1,
                    "name": "Clothes",
                    "image": "https://i.imgur.com/QkIa5tT.jpeg",
    ...
    useEffect(() => {
        ...
        if(searchByCategory)
            _items = filteredItemsByCategory(_items, searchByCategory)

        if(searchByTitle)
            _items = filteredItemsByTitle(_items, searchByTitle)
